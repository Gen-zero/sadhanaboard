// Final test for Tithi calculation
const SHUKLA_TITHIS = [
...
// Test for today (Dec 17, 2025) - should be Krishna Paksha Trayodashi
...
// Test edge cases
console.log('\\nEdge case tests:');
console.log('Dec 16, 2025:', calculateTithi(2025, 11, 16)); // Should be Krishna Paksha Dvadashi
console.log('Dec 18, 2025:', calculateTithi(2025, 11, 18)); // Should be Krishna Paksha Chaturdashi