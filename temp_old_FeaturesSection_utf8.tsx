    ...
    const features = [
        {
            ...
            description: "Your streaks, mantra counts, reading minutes, vow integrity ΓÇö all visible at a glance via the astral plane interface."
        },
        {
            stage: 1,
            icon: ListTodo,
        ...
        },
        {
            ...
            description: "Curated sadhanas, authentic scriptures, guided rituals ΓÇö verified wisdom digitized for the modern seeker."
        },
        {
            stage: 2,
            icon: TrendingUp,
            title: "Sankalpa Metrics",
            description: "Earn XP, Karma Points, and Depth IndexΓäó for true vow completion. Gamify your ascent to enlightenment."
        },
        {
            stage: 3,
            icon: UserCog,
            title: "Guru Tools",
            description: "Assign cards, monitor cohorts, track disciples ΓÇö omniscient oversight from a single dharma dashboard."
        },
        {
            stage: 3,
            icon: Users,
