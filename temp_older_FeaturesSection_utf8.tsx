    ...
    const features = [
        {
            ...
            description: "Your streaks, mantra counts, reading minutes, vow integrity ΓÇö all visible at a glance."
        },
        {
            icon: ListTodo,
            title: "Sadhana To-Do",
        ...
        },
        {
            ...
            description: "Curated sadhanas, authentic scriptures, guided rituals ΓÇö verified and structured."
        },
        {
            icon: TrendingUp,
            title: "Sankalpa Metrics",
            description: "Earn XP, Karma Points, and Depth IndexΓäó for true vow completion."
        },
        {
            icon: Users,
            title: "Guru Tools",
            description: "Assign cards, monitor cohorts, track disciples ΓÇö all from a single dashboard."
        },
        {
            icon: Users,
