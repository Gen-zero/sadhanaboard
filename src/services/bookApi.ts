...
export const bookApi = {
  ...
  async upsertProgress(bookId: number, payload: { position?: Record<string, unknown>; page?: number; percent?: number; timeSpentMinutes?: number }): Promise<{ data: BookProgress }>{
    return req(`/books/${bookId}/reading/progress`, { method: 'POST', body: JSON.stringify(payload) });
  },
  async createBookmark(bookId: number, payload: { label?: string; page?: number; position?: Record<string, unknown>; isPublic?: boolean }): Promise<{ data: Bookmark }>{
  ...
  async updateBookmark(bookId: number, id: number, payload: Partial<{ label?: string; page?: number; position?: Record<string, unknown>; isPublic?: boolean }>): Promise<{ data: Bookmark }>{
  ...
  async createAnnotation(bookId: number, payload: { page?: number; position?: Record<string, unknown>; content?: string; isPrivate?: boolean }): Promise<{ data: Annotation }>{
  ...
  async updateAnnotation(bookId: number, id: number, payload: Partial<{ page?: number; position?: Record<string, unknown>; content?: string; isPrivate?: boolean }>): Promise<{ data: Annotation }>{
