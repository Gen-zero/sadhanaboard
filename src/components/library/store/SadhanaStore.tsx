...
const SadhanaStore: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
        ...
        <CardHeader className="relative z-10">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-3 bg-secondary/20 px-4 py-3 rounded-lg border border-primary/20">
                <TrendingUp className="h-5 w-5 text-primary" />
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <span className="text-lg font-bold text-primary">Level {userLevel}</span>
                  </div>
                  <div className="w-24">
              ...
              <div className="flex items-center gap-2 bg-secondary/20 px-4 py-3 rounded-lg border border-primary/20">
                <Coins className="h-5 w-5 text-gold" />
                <div className="text-center">
                  <p className="text-sm font-medium">Spiritual Points</p>
                  <p className="text-lg font-bold text-gold">{spiritualPoints}</p>
                </div>
              </div>
      ...
      {/* Genre Info */}
      <Card className="border border-primary/20 bg-gradient-to-r from-primary/5 via-secondary/5 to-primary/5">
              ...
              <Badge
                ...
                className={`${
                  progression?.unlockedGenres?.includes(genre.id)
                    ...
                    : 'opacity-50 border border-primary/30'
                }`}
              >
