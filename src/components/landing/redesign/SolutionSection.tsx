...
const SolutionSection = () => {
    return (
        <section className="py-32 px-4 relative overflow-hidden bg-cosmic">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] opacity-[0.06] pointer-events-none animate-[spin_60s_linear_infinite]"
                style={{
                    backgroundImage: `url("data:image/svg+xml,%3Csvg width='100' height='100' viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='50' cy='50' r='40' fill='none' stroke='%23FFD778' stroke-width='1'/%3E%3Cpath d='M50 10 L90 90 L10 90 Z' fill='none' stroke='%23FFD778' stroke-width='1'/%3E%3C/svg%3E")`
                }}
            />
